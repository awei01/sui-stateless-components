...
export const ICONS = [
  ...
  'announcement', 'birthday', 'help circle', 'help circle outline', 'help', 'info circle', 'info', 'warning circle', 'warning', 'warning sign',
...
export const Icon = ({
  type,
  disabled, loading, circular, inverted, bordered,
  color, size,
  className, ...rest }) => {
